...
exports.GetColorName = function (code) {
    var colorToNameConvertor = new HexCodeToColorName();
    var _a = colorToNameConvertor.name(code), hex = _a[0], name = _a[1];
    return name;
};
/*
...
+-----------------------------------------------------------------+
*/
var HexCodeToColorName = /** @class */ (function () {
    function HexCodeToColorName() {
        this.names = [
            ["000000", "Black"],
            ["000080", "Navy Blue"],
            ["0000C8", "Dark Blue"],
        ...
        this.rgb = function (color) { return [parseInt("0x" + color.substring(1, 3)), parseInt("0x" + color.substring(3, 5)), parseInt("0x" + color.substring(5, 7))]; };
        for (var i = 0; i < this.names.length; i++) {
            var color = "#" + this.names[i][0];
            var _a = this.rgb(color), r = _a[0], g = _a[1], b = _a[2];
            var _b = this.hsl(color), h = _b[0], s = _b[1], l = _b[2];
            this.names[i].push(r, g, b, h, s, l);
        }
    }
    HexCodeToColorName.prototype.name = function (color) {
    ...
    HexCodeToColorName.prototype.hsl = function (color) {
        var _a = [parseInt("0x" + color.substring(1, 3)) / 255, parseInt("0x" + color.substring(3, 5)) / 255, parseInt("0x" + color.substring(5, 7)) / 255], r = _a[0], g = _a[1], b = _a[2];
